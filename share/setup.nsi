...
!define URL http://www.cryptojacks.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/cryptojacks.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\cryptojacks-qt.exe
...
OutFile cryptojacks-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/cryptojacks-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/cryptojacksd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\cryptojacks.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\cryptojacks-qt.exe
